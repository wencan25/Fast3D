...
# annos = json.load(open("/mnt/petrelfs/my_username/share/Chat-3D-v2/annotations/scanrefer_mask3d_val_stage2_grounding_OBJ.json"))
...
# scannet_root = '/mnt/petrelfs/share_data/my_username/data/processed/scannet'
...
# folder_path = '/mnt/petrelfs/my_username/share/data/cap3d/8192_npy'
