...
preds = json.load(
    open(
        "/mnt/petrelfs/my_username/share_hw/Chat-3D-v2/outputs/20240829_191645_lr5e-6_ep3_scanrefer#obj_align#nr3d_caption#scan2cap#scanqa#sqa3d#multi3dref__scanrefer_test__chatscene/preds_epoch-1_step0_scanrefer_test.json"
    )
)

instance_attrs = torch.load(
    "/mnt/petrelfs/my_username/share_hw/Chat-3D-v2/annotations/scannet_mask3d_test_attributes.pt",
    map_location="cpu",
)
