...
SCANNET_ROOT = "/mnt/petrelfs/my_username/share/data/ScanNet_V2/scans"
...
if __name__ == "__main__":
    ...
    for i, gt_id in enumerate(gt_ids):
        ...
        write_bbox(gt_bbox + [0.0], i, os.path.join(output_scene_dir, f"gt_{gt_id}.ply"))
